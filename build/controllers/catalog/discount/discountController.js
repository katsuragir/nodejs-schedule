...
class DiscountController {
    list(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const discount = yield database_1.default.query('SELECT id, kode_disc, description,  DATE_FORMAT(from_date, "%Y-%m-%d") as from_date, DATE_FORMAT(to_date, "%Y-%m-%d") as to_date, discount, flag_discount, status, create_by, date_create, time_create, format(discount, 0) as value FROM vh_discount_reg_hdr');

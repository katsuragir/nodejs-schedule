...
class VoucherController {
    list(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const voucher = yield database_1.default.query('SELECT id, voucherid, vouchername, DATE_FORMAT(fromdate, "%Y-%m-%d") as fromdate, DATE_FORMAT(todate, "%Y-%m-%d") as todate, vouchervalue, vouchertab, status, stat, kouta, createdate, updatedate, description, format(vouchervalue, 0) as value, '+
    ...
    detailVoch(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            const voucher = yield database_1.default.query('SELECT * FROM vh_voucher WHERE id = ? LIMIT 1', [id]);
            // console.log(id, voucher);
            res.json(voucher[0]);
        });
    }
